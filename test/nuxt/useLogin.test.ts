...
mockNuxtImport('useRuntimeConfig', (original) => vi.fn<typeof import('#app').useRuntimeConfig>((original) => {
  return {
    ...original,
    public: {}
  }
...
//   return {
//     ...actual,
//     useRouter: vi.fn<typeof import('vue-router').useRouter>(actual.useRouter)
//   }
// })
// mockNuxtImport('useRouter', original => vi.fn<typeof import('vue-router').useRouter>(original))

// mockNuxtImport('preloadRouteComponents', () => vi.fn())

// vi.mock('../../src/runtime/composables/index.ts', async (original) => {
//   const actual = await original<typeof import('../../src/runtime/composables/index.ts')>()

//   return {
//     ...actual,
//     useRouter: vi.fn<typeof import('vue-router').useRouter>(() => ({
//       ...actual.useRouter(),
//       push: vi.fn()
//     }))
//   }
...
describe.only('useLogin', () => {
  it('should return default parameters', async () => {
    const result = useLogin('email', undefined, '/login')
